...
VALUES ('facebook', '2026-01', 3725.40, 5024.60, 1029.20, 0, 0, 0, NOW())
...
INSERT INTO financial_forecast (platform, metric_month, forecast_cost_of_sales, forecast_gross_profit, forecast_other_op_costs, actual_cost_of_sales, actual_gross_profit, actual_other_op_costs, updated_at)
VALUES ('facebook', '2026-02', 3131.40, 5618.60, 862.53, 0, 0, 0, NOW())
ON CONFLICT (platform, metric_month) DO UPDATE SET
...
INSERT INTO financial_forecast (platform, metric_month, forecast_cost_of_sales, forecast_gross_profit, forecast_other_op_costs, actual_cost_of_sales, actual_gross_profit, actual_other_op_costs, updated_at)
VALUES ('facebook', '2026-03', 2887.90, 5862.10, 862.53, 0, 0, 0, NOW())
ON CONFLICT (platform, metric_month) DO UPDATE SET
...
INSERT INTO financial_forecast (platform, metric_month, forecast_cost_of_sales, forecast_gross_profit, forecast_other_op_costs, actual_cost_of_sales, actual_gross_profit, actual_other_op_costs, updated_at)
VALUES ('facebook', '2026-04', 2739.40, 6010.60, 862.53, 0, 0, 0, NOW())
ON CONFLICT (platform, metric_month) DO UPDATE SET
...
INSERT INTO financial_forecast (platform, metric_month, forecast_cost_of_sales, forecast_gross_profit, forecast_other_op_costs, actual_cost_of_sales, actual_gross_profit, actual_other_op_costs, updated_at)
VALUES ('website', '2026-01', 2481.83, 518.17, 0.00, 0, 0, 0, NOW())
ON CONFLICT (platform, metric_month) DO UPDATE SET
...
INSERT INTO financial_forecast (platform, metric_month, forecast_cost_of_sales, forecast_gross_profit, forecast_other_op_costs, actual_cost_of_sales, actual_gross_profit, actual_other_op_costs, updated_at)
VALUES ('website', '2026-02', 1763.19, 1236.81, 0.00, 0, 0, 0, NOW())
ON CONFLICT (platform, metric_month) DO UPDATE SET
...
INSERT INTO financial_forecast (platform, metric_month, forecast_cost_of_sales, forecast_gross_profit, forecast_other_op_costs, actual_cost_of_sales, actual_gross_profit, actual_other_op_costs, updated_at)
VALUES ('website', '2026-03', 0.00, 3000.00, 0.00, 0, 0, 0, NOW())
ON CONFLICT (platform, metric_month) DO UPDATE SET
...
INSERT INTO financial_forecast (platform, metric_month, forecast_cost_of_sales, forecast_gross_profit, forecast_other_op_costs, actual_cost_of_sales, actual_gross_profit, actual_other_op_costs, updated_at)
VALUES ('youtube', '2026-01', 4845.73, -3845.73, 1029.20, 0, 0, 0, NOW())
ON CONFLICT (platform, metric_month) DO UPDATE SET
...
INSERT INTO financial_forecast (platform, metric_month, forecast_cost_of_sales, forecast_gross_profit, forecast_other_op_costs, actual_cost_of_sales, actual_gross_profit, actual_other_op_costs, updated_at)
VALUES ('youtube', '2026-02', 4251.73, -3251.73, 862.53, 0, 0, 0, NOW())
ON CONFLICT (platform, metric_month) DO UPDATE SET
...
INSERT INTO financial_forecast (platform, metric_month, forecast_cost_of_sales, forecast_gross_profit, forecast_other_op_costs, actual_cost_of_sales, actual_gross_profit, actual_other_op_costs, updated_at)
VALUES ('youtube', '2026-03', 4103.23, -3103.23, 862.53, 0, 0, 0, NOW())
ON CONFLICT (platform, metric_month) DO UPDATE SET
...
INSERT INTO financial_forecast (platform, metric_month, forecast_cost_of_sales, forecast_gross_profit, forecast_other_op_costs, actual_cost_of_sales, actual_gross_profit, actual_other_op_costs, updated_at)
VALUES ('youtube', '2026-04', 3954.73, -2954.73, 862.53, 0, 0, 0, NOW())
ON CONFLICT (platform, metric_month) DO UPDATE SET
...
INSERT INTO financial_forecast (platform, metric_month, forecast_cost_of_sales, forecast_gross_profit, forecast_other_op_costs, actual_cost_of_sales, actual_gross_profit, actual_other_op_costs, updated_at)
VALUES ('instagram', '2026-01', 3237.82, -1154.49, 1029.20, 0, 0, 0, NOW())
ON CONFLICT (platform, metric_month) DO UPDATE SET
...
INSERT INTO financial_forecast (platform, metric_month, forecast_cost_of_sales, forecast_gross_profit, forecast_other_op_costs, actual_cost_of_sales, actual_gross_profit, actual_other_op_costs, updated_at)
VALUES ('instagram', '2026-02', 2643.82, -560.49, 862.53, 0, 0, 0, NOW())
ON CONFLICT (platform, metric_month) DO UPDATE SET
...
INSERT INTO financial_forecast (platform, metric_month, forecast_cost_of_sales, forecast_gross_profit, forecast_other_op_costs, actual_cost_of_sales, actual_gross_profit, actual_other_op_costs, updated_at)
VALUES ('instagram', '2026-03', 2400.32, -316.99, 862.53, 0, 0, 0, NOW())
ON CONFLICT (platform, metric_month) DO UPDATE SET
...
INSERT INTO financial_forecast (platform, metric_month, forecast_cost_of_sales, forecast_gross_profit, forecast_other_op_costs, actual_cost_of_sales, actual_gross_profit, actual_other_op_costs, updated_at)
VALUES ('instagram', '2026-04', 2251.82, -168.49, 862.53, 0, 0, 0, NOW())
ON CONFLICT (platform, metric_month) DO UPDATE SET
...
INSERT INTO financial_forecast (platform, metric_month, forecast_cost_of_sales, forecast_gross_profit, forecast_other_op_costs, actual_cost_of_sales, actual_gross_profit, actual_other_op_costs, updated_at)
VALUES ('tiktok', '2026-01', 1843.56, -1843.56, 1029.20, 0, 0, 0, NOW())
ON CONFLICT (platform, metric_month) DO UPDATE SET
...
INSERT INTO financial_forecast (platform, metric_month, forecast_cost_of_sales, forecast_gross_profit, forecast_other_op_costs, actual_cost_of_sales, actual_gross_profit, actual_other_op_costs, updated_at)
VALUES ('tiktok', '2026-02', 1724.76, -1724.76, 862.53, 0, 0, 0, NOW())
ON CONFLICT (platform, metric_month) DO UPDATE SET
...
INSERT INTO financial_forecast (platform, metric_month, forecast_cost_of_sales, forecast_gross_profit, forecast_other_op_costs, actual_cost_of_sales, actual_gross_profit, actual_other_op_costs, updated_at)
VALUES ('tiktok', '2026-03', 1481.26, -1481.26, 862.53, 0, 0, 0, NOW())
ON CONFLICT (platform, metric_month) DO UPDATE SET
...
INSERT INTO financial_forecast (platform, metric_month, forecast_cost_of_sales, forecast_gross_profit, forecast_other_op_costs, actual_cost_of_sales, actual_gross_profit, actual_other_op_costs, updated_at)
VALUES ('tiktok', '2026-04', 1332.76, -1332.76, 862.53, 0, 0, 0, NOW())
ON CONFLICT (platform, metric_month) DO UPDATE SET
...
INSERT INTO financial_forecast (platform, metric_month, forecast_cost_of_sales, forecast_gross_profit, forecast_other_op_costs, actual_cost_of_sales, actual_gross_profit, actual_other_op_costs, updated_at)
VALUES ('x', '2026-01', 1167.88, -1167.88, 851.60, 0, 0, 0, NOW())
ON CONFLICT (platform, metric_month) DO UPDATE SET
...
INSERT INTO financial_forecast (platform, metric_month, forecast_cost_of_sales, forecast_gross_profit, forecast_other_op_costs, actual_cost_of_sales, actual_gross_profit, actual_other_op_costs, updated_at)
VALUES ('x', '2026-02', 930.28, -930.28, 684.93, 0, 0, 0, NOW())
ON CONFLICT (platform, metric_month) DO UPDATE SET
...
INSERT INTO financial_forecast (platform, metric_month, forecast_cost_of_sales, forecast_gross_profit, forecast_other_op_costs, actual_cost_of_sales, actual_gross_profit, actual_other_op_costs, updated_at)
VALUES ('x', '2026-03', 781.78, -781.78, 684.93, 0, 0, 0, NOW())
ON CONFLICT (platform, metric_month) DO UPDATE SET
...
INSERT INTO financial_forecast (platform, metric_month, forecast_cost_of_sales, forecast_gross_profit, forecast_other_op_costs, actual_cost_of_sales, actual_gross_profit, actual_other_op_costs, updated_at)
VALUES ('x', '2026-04', 633.28, -633.28, 684.93, 0, 0, 0, NOW())
ON CONFLICT (platform, metric_month) DO UPDATE SET
...
INSERT INTO financial_forecast (platform, metric_month, forecast_cost_of_sales, forecast_gross_profit, forecast_other_op_costs, actual_cost_of_sales, actual_gross_profit, actual_other_op_costs, updated_at)
VALUES ('recharge', '2026-02', 1650.63, 0.00, 0.00, 0, 0, 0, NOW())
ON CONFLICT (platform, metric_month) DO UPDATE SET
...
INSERT INTO financial_forecast (platform, metric_month, forecast_cost_of_sales, forecast_gross_profit, forecast_other_op_costs, actual_cost_of_sales, actual_gross_profit, actual_other_op_costs, updated_at)
VALUES ('recharge', '2026-03', 0.00, 0.00, 0.00, 0, 0, 0, NOW())
ON CONFLICT (platform, metric_month) DO UPDATE SET
  forecast_cost_of_sales = 0.00,
  forecast_gross_profit = 0.00,
  forecast_other_op_costs = 0.00,
...
INSERT INTO financial_forecast (platform, metric_month, forecast_cost_of_sales, forecast_gross_profit, forecast_other_op_costs, actual_cost_of_sales, actual_gross_profit, actual_other_op_costs, updated_at)
VALUES ('total', '2026-01', 15101.40, -268.06, 4968.40, 0, 0, 0, NOW())
ON CONFLICT (platform, metric_month) DO UPDATE SET
...
INSERT INTO financial_forecast (platform, metric_month, forecast_cost_of_sales, forecast_gross_profit, forecast_other_op_costs, actual_cost_of_sales, actual_gross_profit, actual_other_op_costs, updated_at)
VALUES ('total', '2026-02', 12794.56, 2038.77, 4135.07, 0, 0, 0, NOW())
ON CONFLICT (platform, metric_month) DO UPDATE SET
...
INSERT INTO financial_forecast (platform, metric_month, forecast_cost_of_sales, forecast_gross_profit, forecast_other_op_costs, actual_cost_of_sales, actual_gross_profit, actual_other_op_costs, updated_at)
VALUES ('total', '2026-03', 11654.50, 3178.83, 4135.07, 0, 0, 0, NOW())
ON CONFLICT (platform, metric_month) DO UPDATE SET
...
INSERT INTO financial_forecast (platform, metric_month, forecast_cost_of_sales, forecast_gross_profit, forecast_other_op_costs, actual_cost_of_sales, actual_gross_profit, actual_other_op_costs, updated_at)
VALUES ('total', '2026-04', 10912.00, 3921.33, 4135.07, 0, 0, 0, NOW())
ON CONFLICT (platform, metric_month) DO UPDATE SET
